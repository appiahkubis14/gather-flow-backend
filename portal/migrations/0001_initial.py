    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "child_school_absence_reason_other",
                    models.CharField(
                        blank=True,
                        help_text="Specify the reason if 'Other' is selected.",
                        max_length=200,
                ...
                (
                    ...
                    multiselectfield.db.fields.MultiSelectField(
                        ...
                        help_text="Select tasks performed in the last 7 days",
                        max_length=500,
                    ),
                ),
                (
                    "remuneration_received",
                    models.CharField(
                        choices=[("yes", "Yes"), ("no", "No")],
                ...
                (
                    "light_duty_duration_non_school",
                    models.CharField(
                        choices=[
                            ("<1", "Less than 1 hour"),
                            ("1-2", "1-2 hour"),
                ...
                (
                    "total_hours_light_work_school",
                    models.IntegerField(
                        help_text="How many hours in total did the child spend in light work during SCHOOL DAYS in the past 7 days?"
                    ),
                ),
                (
                    "total_hours_light_work_non_school",
                    models.IntegerField(
                        help_text="How many hours in total did the child spend on light duty during NON-SCHOOL DAYS in the past 7 days?"
                    ),
                ),
                (
                    "performed_tasks_12months",
                    multiselectfield.db.fields.MultiSelectField(
                        blank=True,
                        help_text="Which of these tasks has child %rostertitle% performed in the last 12 months? If multiple tasks, separate their keys using commas.",
                        max_length=500,
                        null=True,
                    ),
                ),
                (
                    "remuneration_received_12months",
                    models.CharField(
                        choices=[("yes", "Yes"), ("no", "No")],
                ...
                (
                    "light_duty_duration_non_school_12",
                    models.CharField(
                        choices=[
                            ("<1", "Less than 1 hour"),
                            ("1-2", "1-2 hour"),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Which of the following tasks has the child done in the last 7 days on the cocoa farm? If multiple tasks apply, list the keys separated by commas.",
                        max_length=500,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Which of the following tasks has the child performed in the last 12 months on the cocoa farm? If multiple tasks apply, list the keys separated by commas.",
                        max_length=500,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (
                                "falling_bicycle",
                                "Falling of a bicycle, scooters or tricycle",
                            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "who_answers_child_unavailable_other",
                    models.CharField(
                        blank=True,
                        max_length=100,
                ...
                (
                    "child_birth_certificate_reason",
                    models.CharField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(verbose_name="Interview Start/Pick-up Time"),
                ),
                (
                    "gps_point",
                    models.CharField(
                        max_length=100, verbose_name="GPS Point of the Household"
                    ),
                ),
                (
                    "community_type",
                ...
                (
                    "refusal_toa_participate_reason_survey",
                    models.CharField(
                        blank=True,
                        help_text="If the farmer refused to participate, provide the reason here.",
                        max_length=500,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "farmer_code",
                    models.CharField(
                        help_text="Select farmer to auto-fill details.",
                        max_length=50,
                        unique=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Auto-fetched from API based on farmer_code.",
                        max_length=50,
                    ),
                ),
                ...
                (
                    "num_farmer_children",
                    models.IntegerField(
                        default=0, verbose_name="Number of children (5-17 years)"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Child's full name", max_length=100),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(
                        help_text="Enter full name without special characters.",
                        max_length=200,
                        validators=[
                            django.core.validators.RegexValidator(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "DiffComm",
                                "No, born in this district but different community",
                            ),
                            (
                                "DiffDist",
                                "No, born in this region but different district",
                            ),
                ...
                (
                    "child_relationship_to_head_other",
                    models.CharField(
                        blank=True,
                ...
                (
                    "child_not_live_with_family_reason",
                    models.CharField(
                        blank=True,
                        choices=[
                ...
                (
                    "child_not_live_with_family_reason_other",
                    models.CharField(
                        blank=True,
                        max_length=200,
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="child_household_details",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="portal.childreninhouseholdtbl",
            ),
        ),
        migrations.AddField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (
                                "Coaretaker/Manager of the farm",
                                "Coaretaker/Manager of the farm",
                            ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="portal.farmeridentification_info_onvisit_tbl",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="portal.householdsensitizationtbl",
                    ),
                ),
            ],
        ),
